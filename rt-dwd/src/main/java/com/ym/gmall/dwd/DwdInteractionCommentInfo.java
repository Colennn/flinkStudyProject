...
import com.ym.gmall.common.base.BaseSQLApp;
...
public class DwdInteractionCommentInfo extends BaseSQLApp {
    public static void main(String[] args) {
        new DwdInteractionCommentInfo().start(2003, 1,
    ...
    public void handle(StreamExecutionEnvironment env, StreamTableEnvironment tEnv) {
        ...
        // 2. 过滤出评论表数据
        // 3. 通过 ddl 的方式建表 base_dic (从 hbase 中取数
        // 4. 事实表与维度表的 join：lookup join 关联动态表用到的语法
        // 5. 通过 ddl 的方式建表：与 kafka 的 topic 关联
        // 6. 结果写入到 kafka
